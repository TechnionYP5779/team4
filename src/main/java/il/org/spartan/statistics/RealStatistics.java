...
public class RealStatistics extends ImmutableStatistics {
  ...
  @SuppressWarnings("static-method") public static class TEST {
    ...
    @Test public void all() {
      ...
      azzert.aye(11 -vs[0] < 1E-20 && 11-vs[0] > -1*1E-20);
      azzert.aye(20 -vs[1] < 1E-20 &&  20-vs[1] > -1*1E-20);
      azzert.aye(5-vs[2] < 1E-20 && 5-vs[2] > -1*1E-20);
    }
    ...
    @Test public void max() {
      azzert.aye(20-s11_20_5.max() < 1E-6 && 20-s11_20_5.max() > -1*1E-6);
      azzert.aye(5-s15.max() < 1E-6 && 5-s15.max() > -1*1E-6);
      azzert.aye(7-s07.max() < 1E-6 && 7-s07.max() > -1*1E-6);
      azzert.aye(1-s_4x0_5x1.max() < 1E-6 && 1-s_4x0_5x1.max() > -1*1E-6);

    }

    @Test public void mean() {
      azzert.aye(12-s11_20_5.mean() < 1E-6 && 12-s11_20_5.mean() > -1*1E-6);
      azzert.aye(3-s15.mean() < 1E-6 && 3-s15.mean() > -1*1E-6);
      azzert.aye(3.5-s07.mean() < 1E-6 && 3.5-s07.mean() > -1*1E-6);
      azzert.aye(5/ 9.0-s_4x0_5x1.mean() < 1E-6 && 5/ 9.0-s_4x0_5x1.mean() > -1*1E-6);

    }

    @Test(expected = ArithmeticException.class) public void meanEmpty() {
      final @NotNull RealStatistics x = new RealStatistics();
      azzert.aye(x.mean() < 1E-20 &&  x.mean() > -1*1E-20);
      x.relativeError();
    }
    ...
    @Test public void median() {
      azzert. assertEquals(11, s11_20_5.median(), 1E-6);
      azzert. assertEquals(3, s15.median(), 1E-6);
      azzert.  assertEquals(3.5, s07.median(), 1E-6);
      azzert.assertEquals(1, s_4x0_5x1.median(), 1E-6);
      azzert.assertEquals(1, s_4x0_5x1.record(1).median(), 1E-6);
      azzert. assertEquals(1, s_4x0_5x1.record(5).median(), 1E-6);
      azzert. assertEquals(1, s_4x0_5x1.record(5).record(6).median(), 1E-6);
      azzert. assertEquals(1, s_4x0_5x1.record(0).median(), 1E-6);
      azzert. assertEquals(1, s_4x0_5x1.record(0).median(), 1E-6);
      azzert. assertEquals(1, s_4x0_5x1.record(0).median(), 1E-6);
      azzert. assertEquals(1, s_4x0_5x1.record(0).median(), 1E-6);
      azzert. assertEquals(0.5, s_4x0_5x1.record(0).median(), 1E-6);
      azzert.assertEquals(0, s_4x0_5x1.record(0).median(), 1E-6);
    }
    ...
    @Test public void medianMovingDown() {
      azzert.assertEquals(0, s_4x0_5x1.record(0).record(0).median(), 1E-6);
    }
    ...
    @Test public void min() {
      azzert.assertEquals(5, s11_20_5.min(), 1E-6);
      azzert. assertEquals(1, s15.min(), 1E-6);
      azzert. assertEquals(0, s07.min(), 1E-6);
      azzert.assertEquals(0, s_4x0_5x1.min(), 1E-6);
    }
    ...
    @Test public void sum() {
      azzert.  assertEquals(36, s11_20_5.sum(), 1E-6);
      azzert. assertEquals(15, s15.sum(), 1E-6);
      azzert. assertEquals(28, s07.sum(), 1E-6);
      azzert. assertEquals(5.0, s_4x0_5x1.sum(), 1E-6);
    }

    @Test public void testMax() {
      azzert.assertEquals(20, s.max(), 1E-6);
      azzert.assertEquals(5, s15.max(), 1E-6);
      azzert. assertEquals(7, s07.max(), 1E-6);
      azzert.assertEquals(1, s_4x0_5x1.max(), 1E-6);
    }

    @Test public void testMean() {
      azzert. assertEquals(12, s.mean(), 1E-6);
      azzert. assertEquals(3, s15.mean(), 1E-6);
      azzert. assertEquals(3.5, s07.mean(), 1E-6);
      azzert.assertEquals(5 / 9.0, s_4x0_5x1.mean(), 1E-6);
    }

    @Test public void testMedian() {
      azzert.assertEquals(11, s.median(), 1E-6);
      azzert. assertEquals(3, s15.median(), 1E-6);
      azzert.assertEquals(3.5, s07.median(), 1E-6);
      azzert. assertEquals(1, s_4x0_5x1.median(), 1E-6);
      azzert. assertEquals(1, s_4x0_5x1.record(1).median(), 1E-6);
    ...
    @Test public void testMin() {
      azzert. assertEquals(5, s.min(), 1E-6);
      azzert.  assertEquals(1, s15.min(), 1E-6);
      azzert.  assertEquals(0, s07.min(), 1E-6);
      azzert. assertEquals(0, s_4x0_5x1.min(), 1E-6);
    }
    ...
    @Test public void testSum() {
      azzert.assertEquals(36, s.sum(), 1E-6);
      azzert.assertEquals(15, s15.sum(), 1E-6);
      azzert.assertEquals(28, s07.sum(), 1E-6);
      azzert.assertEquals(5.0, s_4x0_5x1.sum(), 1E-6);
    }
